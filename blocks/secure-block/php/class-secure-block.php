...
class Secure_Block {
	...
	public function register_dynamic_block() {
		...
		register_block_type( 'matt-watson/secure-block', [
			'render_callback' => function( array $attributes, string $content = null ) {
				return $this->render_dynamic_block( 'matt-watson/secure-block', $attributes, $content );
			},
		] );
	}

	/**
	 * Server rendering for /blocks/secure-block
	 */
	public function render_dynamic_block( $name, $attributes, $content ) {
